...
#if defined(_DEBUG)
	#define	JK_VERSION		"(debug)SoF2-MP: v"VERSION_STRING_DOTTED
#elif defined(FINAL_BUILD)
	#define	JK_VERSION		"SoF2-MP: v"VERSION_STRING_DOTTED
#else
	#define	JK_VERSION		"(internal)SoF2-MP: v"VERSION_STRING_DOTTED
#endif
